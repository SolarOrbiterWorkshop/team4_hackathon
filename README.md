# Team 4 – Solar eruptive events: tracking flares, CMEs and particles from the Sun to the heliosphere  
...
1. Selecting one or more well-observed flare + CME + SEP events from Solar Orbiter data.  
2. Performing coordinated analyses:  
...
3. Producing notebooks / scripts that perform reproducible analyses (Python + SunPy, etc.).  
4. Documenting our workflow and results: summary report (markdown or Jupyter), figures, event timeline, key metrics.  
5. (Optional) Preparing a short presentation or poster summarising our findings at the end of the week.
